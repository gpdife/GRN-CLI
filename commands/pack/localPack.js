...
/**
 * 1、pack grn_entry_common.js 生成rn_common
 * 2、pack index.js，生成rn_GRNDemo
 * 3、拷贝rn_commmon和rn_GRNDemo到publish
 */
function localPack() {
	return new Promise(resolve => {
		...
		var packageName = option['package-name'] || packConfig['packageName'] || 'GRNDemo';
