"use strict";
/** 
 * 修改node_modules/metro/src/shared/output/RamBundle/as-assets.js输出产物，增加GRN相关配置文件
*/
...
const MAGIC_RAM_BUNDLE_FILENAME = "_grn_unbundle";
const MODULES_DIR = "js-modules";
const CONFIG_FILE_NAME_V2 = "_grn_config_v2";
...
function GRNSaveAsAssets(bundle, options, log, writeModules) {
...
module.exports = GRNSaveAsAssets;
