"use strict";
/** 
 * 修改node_modules/metro/src/shared/output/bundle.js输出产物，增加GRN相关配置文件
*/
...
var GRNSaveBundleAndMap = function(bundle, options, log) {
  const bundleOutput = options.bundleOutput,
    encoding = options.bundleEncoding,
    sourcemapOutput = options.sourcemapOutput,
    sourcemapSourcesRoot = options.sourcemapSourcesRoot; //GRN BEGIN
...
module.exports = GRNSaveBundleAndMap;
