const config = [
    {
        from: "./metro/grn/grn-as-assets.js",
        to: "node_modules/metro/src/shared/output/RamBundle/grn-as-assets.js",
        comments: "为ram-bundle抽取的grn的逻辑文件"
    },
    {
        from: "./metro/grn/grn-bundle.js",
        to: "node_modules/metro/src/shared/output/grn-bundle.js",
        comments: "为bundle抽取的grn的逻辑文件"
    },
    {
        from: "./metro/grn/grn-createModuleIdFactory.js",
    ...
    {
        from: "./react-native/grn/grn-lazyRequire.js",
    ...
    },
    {
        ...
        comments: "add global.GRN_BUILD_COMMON",
    },
    {
    ...
    {
        from: "./grn/rn-cli.config.js",
        to: "./rn-cli.config.js",
        comments: "add rn-cli.config.js",
    },
    {
        from: "./grn/grn_common_entry.js",
        to: "./grn_common_entry.js",
        comments: "add grn_common_entry.js",
    }
];
